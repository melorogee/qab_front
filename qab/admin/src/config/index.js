...
const form = {
    ...
    examinationPaperRulesPercentList: { type: 'examinationPaperRulesPercentList', label: '题库提取占比(1-100%)', prop: 'examinationPaperRulesPercentList', propType: 'Array', props: ['libraryId', 'percent'], api: 'examList', dataKey: { value: 'idx', label: 'libraryName' }, row: 3 },
    serviceItemsList: { type: 'serviceItemsList', label: '服务项目', prop: 'serviceItemsList', propType: 'Array', props: ['name', 'price', 'type'], row: 3 },
    ...
    expertUser: { type: 'input', label: '实名制', prop: 'name' },
    ...
    rightAnswer: { type: 'input', label: '正确答案', prop: 'rightAnswer', max: 20 },
...
const table = {
    ...
    expertUser: { prop: 'name', label: '实名制' },
